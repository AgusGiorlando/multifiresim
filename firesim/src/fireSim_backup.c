...
int    Rows   = 95;     /* Number of rows in each map.  Se recibe por parametro */
int    Cols   = 90;     /* Number of columns in each map. Se recibe por parametro */
double CellWd = 128.937;    /* Cell width (E-W) in feet. Donde 1 feet = 30.45 cm.  Se recibe por parametro*/
double CellHt = 185.0394;    /* Cell height (N-S) in feet. */
...
static int Model = 1;		/* Se recibe por parametro */
...
static double M1      = 0.10;//0.113;    /* 1-hr dead fuel moisture */
static double M10     = 0.10;//0.113;    /* 10-hr dead fuel moisture */
static double M100    = 0.10;//0.113;    /* 100-hr dead fuel moisture */
static double Mherb   = 1.0;//1.77952;   /* Live herbaceous fuel moisture */
